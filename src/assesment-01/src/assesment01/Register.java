...
public class Register {
	...
	public static void main(String[] args) {
		...
		/*
		 * Person person1 = new Person("aceng", "lahat"); error cus Person is an
		 * abstarct class, it can only be call by Person child class, in this is Student
		 * class and Teacher class;
		 */
		...
		if (choose == 1) {
			Teacher teacher = new Teacher("Darwin", "Ancol");
			...
			Student student = new Student("Knowless", "Jakarta");
